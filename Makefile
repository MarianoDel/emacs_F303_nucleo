...
ASRC = ./startup_src/startup_stm32f303xe.s
...
#
LDSCRIPT = $(LINKER)/STM32F303RETx_FLASH.ld
...
flash:
	sudo openocd -f stm32f3_flash.cfg

gdb:
	sudo openocd -f stm32f3_gdb.cfg

reset:
	sudo openocd -f stm32f3_reset.cfg
